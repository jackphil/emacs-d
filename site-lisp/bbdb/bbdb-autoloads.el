...
;;;;;;  bbdb-submit-bug-report) "bbdb" "bbdb.el" (17147 57824))
...
(custom-autoload (quote bbdb-multiple-buffers) "bbdb")
...
;;;;;;  "bbdb-com" "bbdb-com.el" (17170 7576))
...
(custom-autoload (quote bbdb-update-records-mode) "bbdb-com")
...
(custom-autoload (quote bbdb-get-addresses-headers) "bbdb-com")
...
(custom-autoload (quote bbdb-get-only-first-address-p) "bbdb-com")
...
;;;;;;  "bbdb-migrate" "bbdb-migrate.el" (17146 50295))
...
(custom-autoload (quote bbdb/vm-set-auto-folder-alist-field) "bbdb-vm")
...
(custom-autoload (quote bbdb/vm-set-auto-folder-alist-headers) "bbdb-vm")
...
;;;;;;  "bbdb-w3" "bbdb-w3.el" (15416 51980))
...
(custom-autoload (quote bbdb-sounds-directory) "bbdb-xemacs")

(defvar bbdb-sound-volume 50 "\
Volume for playing sounds.")

(custom-autoload (quote bbdb-sound-volume) "bbdb-xemacs")
